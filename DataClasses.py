...
# NIgnjatovic, 2021-12-14, Updated File
#------------------------------------------#
...
class CD:
    ...
    def add_track(self, track: Track) -> None:
        """Adds a track to the CD / Album then sorts album by position.
    ...
    def rmv_track(self, track_id: int) -> None:
        """Removes the track identified by track_id from Album then sorts traks by position.
